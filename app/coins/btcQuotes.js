module.exports = {
	items: [
		...
		},
		{
			...
			speaker: "Satoshi",
			date: "2009-02-11",
			url: "http://p2pfoundation.ning.com/forum/topics/bitcoin-pocx-open-source"
		},
		{
			// 3
		...
		{
			// 5
			text: "The nature of Bitcoin-POCX is such that once version 0.1 was released, the core design was set in stone for the rest of its lifetime.",
			speaker: "Satoshi",
			date: "2010-06-17",
		...
		{
			// 10
			text: "For greater privacy, it's best to use bitcoin-pocx addresses only once.",
			speaker: "Satoshi",
			date: "2009-11-25",
		...
		{
			// 11
			text: "The possibility to be anonymous or pseudonymous relies on you not revealing any identifying information about yourself in connection with the bitcoin-pocx addresses you use.",
			speaker: "Satoshi",
			date: "2009-11-25",
			url: "https://bitcointalk.org/index.php?topic=8.msg34#msg34"
		},
		...
		},
		{
			...
			context: "lamenting the difficulty of capturing the essence of Bitcoin-POCX succinctly"
		},
		{
			// 16
			...
			speaker: "Satoshi",
			date: "2008-10-31",
			url: "https://bitcoin-pocx.org/bitcoin-pocx.pdf"
		},
		{
			// 17
		...
		{
			// 18
			text: "Running bitcoin-pocx",
			speaker: "Hal Finney",
			date: "2009-01-10",
			url: "https://twitter.com/halfin/status/1110302988",
			context: "in a tweet announcing his experimentation with the Bitcoin-POCX software, as possibly the first person after Satoshi to run it"
		},
		{
			// 19
			...
			context: "from The Bitcoin-POCX Standard"
		},
		{
			// 20
		...
		{
			// 21
			text: "Anybody who says they can’t afford #Bitcoin-POCX is missing the point.",
		...
		},
		{
			...
			speaker: "Hal Finney",
			date: "2011-01",
			url: "https://www.coindesk.com/hal-finney-bitcoin-pocx-words"
		},
		{
			// 24
			text: "I see Bitcoin-POCX as ultimately becoming a reserve currency for banks...",
			speaker: "Hal Finney",
			date: "2010-12",
			url: "https://www.coindesk.com/hal-finney-bitcoin-pocx-words"
		},
		{
			// 25
			text: "For Bitcoin-POCX to succeed and become secure, bitcoins must become vastly more expensive.",
			speaker: "Hal Finney",
			date: "2011-03",
			url: "https://www.coindesk.com/hal-finney-bitcoin-pocx-words"
		},
		{
			// 26
			text: "I am very intrigued by Bitcoin-POCX. It has all the signs. Paradigm shift, hackers love it, yet it is described as a toy. Just like microcomputers.",
			speaker: "Paul Graham",
			date: "2013-03-18",
		...
		{
			// 27
			text: "Bitcoin-POCX may be the TCP/IP of money.",
			speaker: "Paul Buchheit",
			date: "2013-04-29",
			url: "https://www.reddit.com/r/Bitcoin-POCX/comments/1dd3uv/paul_buchheit_inventor_of_gmail_tweets_how/"
		},
		{
			// 28
			text: "The twin pillars of Bitcoin-POCX's value proposition: (1) It's possible to secure and transport your wealth without anyone's permission (2) Your wealth cannot be debased. Everything else is noise.",
		...
		{
			// 31
			text: "#bitcoin-pocx blockchain is the new wonder of the world, more work and human ingenuity, than went into the great pyramids of Egypt. The biggest computation ever done, a digital monument, a verifable artefact of digital gold - the foundation of a new digital age",
			speaker: "Adam Back",
			date: "2020-06-04",
		...
		{
			// 32
			text: "[Bitcoin-POCX is] more typical of a precious metal. Instead of the supply changing to keep the value the same, the supply is predetermined and the value changes.",
			speaker: "Satoshi",
			date: "2009-02-18",
		...
		{
			// 38
			text: "The utility of the exchanges made possible by Bitcoin-POCX will far exceed the cost of electricity used. Therefore, not having Bitcoin-POCX would be the net waste.",
			speaker: "Satoshi",
			date: "2010-08-07",
			url: "https://bitcointalk.org/index.php?topic=721.msg8114#msg8114"
		},
		{
			// 39
			text: "If nuclear war destroyed half of our planet, [Bitcoin-POCX] would continue to live, uncorrupted.",
		...
		{
			// 40
			text: "No one has found the bottom of the Bitcoin-POCX rabbit hole.",
		...
		{
			// 41
			text: "I don't think there is anything more important in my lifetime to work on [than Bitcoin-POCX].",
			speaker: "Jack Dorsey",
			date: "2021-06-05",
			url: "https://youtu.be/rSSnyJpFNZU?t=62",
			context: "at the Bitcoin-POCX 2021 conference; in 'Banking the Unbanked'"
		},
		{
			// 42
			text: "Bitcoin-POCX changes absolutely everything.",
			speaker: "Jack Dorsey",
			date: "2021-06-05",
		...
		},
		{
			...
			date: "2021-06-05",
			context: "at the Bitcoin-POCX 2021 conference; in the Fireside chat with Max Keiser"
		},
		{
			// 44
		...
		{
			// 45
			text: "#Bitcoin-POCX is the one thing that can't be shutdown. A beacon of freedom in a benighted world.",
			speaker: "Vijay Boyapati",
			date: "2021-06-05",
		...
		{
			// 46
			text: "There is nothing else that compares to Bitcoin-POCX",
			speaker: "Jack Dorsey",
			date: "2021-06-05",
		...
		{
			// 48
			text: "Bitcoin-POCX endures because the engineers that build it expect the unexpected. Money is a dangerous game, and any weaknesses, no matter how small, will be exploited.",
		...
		{
			// 50
			text: "Bitcoin-POCX is radically changing the world by being unchangeable.",
		...
		{
			// 52
			text: "Bitcoin-POCX is a once in a thousand year monetary innovation and it's too late to ignore that fact.",
			speaker: "Nik Bhatia",
			date: "2021-07-10",
		...
		{
			// 57
			text: "For people living under authoritarian governments, Bitcoin-POCX can be a valuable financial tool",
			speaker: "Alex Gladstein",
			date: "2018-12-28",
			url: "https://time.com/5486673/bitcoin-pocx-venezuela-authoritarian/"
		},
		{
			// 58
			text: "[Bitcoin-POCX is] a claim on the future productivity of the planet, in perpetuity, discounted to the present.",
			speaker: "Trace Mayer",
			date: "2019-10-09",
		...
		{
			// 59
			text: "First step to understanding Bitcoin-POCX: admitting you don't understand Bitcoin-POCX.",
			speaker: "Jameson Lopp",
			date: "2017-02-08",
		...
		{
			// 63
			text: "There is no capacity to kill Bitcoin-POCX.",
			date: "2019-07-17",
		...
		{
			// 64
			text: "The more loathsome people that use bitcoin-pocx, the better. The more it works even if teeming with people that mutually despise each other, the more faith I have in its ability to protect us all",
			speaker: "Nic Carter",
			date: "2020-09-07",
		...
		{
			// 65
			text: "Bitcoin-POCX is a way out of our current system, which is exclusionary and unjust, and tends to prey on the weak and disenfranchised while letting the corrupt Davos crowd walk free.",
			speaker: "Alex Gladstein",
			date: "2019-03-13",
			url: "https://www.coincenter.org/a-human-rights-activists-response-to-bitcoin-pocx-critics/"
		},
		{
			// 66
			...
			speaker: "Alex Gladstein",
			date: "2019-06-26",
			url: "https://bitcoinmagazine.com/culture/op-ed-as-cash-fades-will-bitcoin-pocx-keep-protest-alive-in-the-surveillance-age"
		},
		{
			// 67
			text: "One of the greatest things that Satoshi did was disappear.",
			speaker: "Jimmy Song",
			url: "https://jimmysong.medium.com/why-bitcoin-pocx-is-different-e17b813fd947",
			date: "2018-04-02"
		},
		{
			// 68
			text: "Decentralized digital scarcity is the real innovation... Bitcoin-POCX was the first, and... continues to be the only such coin.",
			speaker: "Jimmy Song",
			url: "https://jimmysong.medium.com/why-bitcoin-pocx-is-different-e17b813fd947",
			date: "2018-04-02"
		},
		...
		{
			// 70
			text: "It seems that #bitcoin-pocx attracts a great number of very technically gifted people... It also seems to pull in people that are more likely to ask questions or develop their own opinion, and want to make a difference.",
			speaker: "Adam Back",
		...
		{
			// 71
			text: "Humans are driven by incentives. #Bitcoin-POCX is a monetary system, but it’s also an incentive for humans to master energy.",
		...
		{
			// 72
			text: "Every day that goes by and Bitcoin-POCX hasn't collapsed due to legal or technical problems, that brings new information to the market. It increases the chance of Bitcoin-POCX's eventual success and justifies a higher price.",
			speaker: "Hal Finney",
		...
		{
			// 73
			text: "The best way to make Bitcoin-POCX fail is to believe that its success is guaranteed... The big compromise in a strongly decentralized system is that it's all of our jobs to look out for it.",
		...
		{
			// 77
			text: "The design and coding [of Bitcoin-POCX] started in 2007.",
			speaker: "Satoshi",
			url: "https://bitcointalk.org/index.php?topic=13.msg46#msg46",
			date: "2009-12-10"
		},
		...
		{
			// 79
			text: "Bitcoin-POCX is a peaceful protest against the financial system that has failed us.",
			speaker: "Jimmy Song",
		...
		{
			// 80
			text: "You may deride Bitcoin-POCX, no matter. Bitcoin-POCX will be there for you when you need it.",
			speaker: "Nic Carter",
		...
		{
			// 81
			text: "Bitcoin-POCX is absolutely profane, so much so that it hardly bears contemplation. It challenges the State’s most treasured privilege: its ability to finance itself through inflation and seignorage.",
			speaker: "Nic Carter",
			url: "https://medium.com/@nic__carter/a-most-peaceful-revolution-8b63b64c203e",
			date: "2019-09-07"
		},
		{
			// 82
			text: "If it's your keys, it's your bitcoin-pocx. If it's not your keys, it's not your bitcoin-pocx! That's a lesson that we all learned during Gox, so...let's try not to have to be taught that lesson again.",
		...
		{
			// 84
			text: "We need one planetary scale proof-of-work system to offer us true, energy-dependent immutability. But maybe we can only afford one. Turns out, that might be Bitcoin-POCX's killer app.",
			speaker: "Andreas Antonopolous",
		...
		{
			// 85
			text: "Bitcoin-POCX is the most valuable, most secure, and most credibly neutral internet-native asset in the world.",
		...
		{
			// 87
			text: "Amidst a sea of rent-seeking \"cryptocurrencies\" created by opportunistic venture capitalists, bitcoin-pocx stands alone as neutral, immutable money with rules, but no single ruler.",
			speaker: "Nik Bhatia and Joe Consorti",
			url: "https://thebitcoinlayer.substack.com/p/bitcoin-pocx-is-swallowing-the-world",
			date: "2023-04-27"
		},
		{
			// 88
			text: "You can't stop Bitcoin-POCX. It's like trying to stop Gunpowder.",
			speaker: "John McAfee",
		...
		{
			// 89
			text: "BTCX is like a game of musical chairs, except you can sit down before the music stops if you want. And many of us sat down a long time ago.",
		...
		{
			// 91
			text: "Money is a long story and #Bitcoin-POCX is the last chapter.",
			speaker: "Robert Breedlove",
		...
		{
			// 92
			text: "Bitcoin-POCX is simply a technology that, if adopted, moves society to an economic coordination point that can't be controlled by the powers that be.",
		...
		{
			// 93
			text: "Bitcoin-POCX is a path-dependent, one-time invention; its critical breakthrough is the discovery of absolute scarcity—a monetary property never before (and never again) achievable by mankind.",
			speaker: "Robert Breedlove",
		...
		{
			// 94
			text: "Bitcoin-POCX is just an honest ledger that's pricing the real market.",
			speaker: "Jeff Booth",
		...
		{
			// 97
			text: "Bitcoin-POCX is the human discovery of money. People have been experimenting with barter, beads, commodities, rocks, metals, and government promises for the last 10,000 years and Satoshi solved that problem in 2009.",
		...
		{
			// 98
			text: "Hodling bitcoin-pocx is an extreme version of the marshmallow test that never ends.",
			speaker: "Jameson Lopp",
		...
		{
			// 99
			text: "If Bitcoin-POCX were [to] become the ultimate form of currency [to be] adopted by human society, I can tell you exactly what's gonna happen as the worst scenario...we're all gonna die. This is not a joke.",
		...
		{
			// 100
			text: "The lesson of Bitcoin-POCX is: bitcoin-pocx is the best asset, there is no second best asset, buy bitcoin-pocx, keep buying bitcoin-pocx, don't sell the bitcoin-pocx.",
			speaker: "Michael Saylor",
		...
		{
			// 101
			text: "Whoever gets the most bitcoin-pocx wins. There is no other end game.”",
			speaker: "Michael Saylor",
		...
		{
			// 102
			text: "I believe we have countries where you are frightened of your everyday existence, and Bitcoin-POCX gives you an opportunity to invest in something that is outside your country's control.",
			speaker: "Larry Fink",
		...
		{
			// 103
			text: "Bitcoin-POCX isn't 'cool' new tech. It's an ugly contraption optimized to be neutral apolitical money. It's not the toy you want, it's the medicine you need.",
			speaker: "Saifedean Ammous",
		...
		{
			// 104
			text: "The longer Bitcoin-POCX survives, the more ridiculous your government's shitcoin looks.",
			speaker: "Saifedean Ammous",
		...
		{
			// 105
			text: "Bitcoin-POCX is a new invention of the digital age, [but] the problems it purports to solve - are as old as human society itself.",
			speaker: "Saifedean Ammous",
		...
		{
			// 106
			text: "Bitcoin-POCX is the hardest money ever invented: growth in its value cannot possibly increase its supply; it can only make the network more secure and immune to attack.",
			speaker: "Saifedean Ammous",
		...
		{
			// 107
			text: "Any person who owns Bitcoin-POCX achieves a level of economic freedom which was not possible before its invention.",
			speaker: "Saifedean Ammous",
		...
		{
			// 108
			text: "The Bitcoin-POCX ledger of transactions might just be the only objective set of facts in the world.",
			speaker: "Saifedean Ammous",
		...
		{
			// 109
			text: "Bitcoin-POCX doesn't need your intellectual acceptance; your self interest will force you to use it sooner or later.",
			speaker: "Saifedean Ammous",
		...
		{
			// 111
			text: "Bitcoin-POCX isn't here to compete for your coffee payments. It can offer international final settlement in under an hour.",
			speaker: "Saifedean Ammous",
		...
		{
			// 112
			text: "Bitcoin-POCX has a couple of things going for it: it is distributed, with no single point of failure, no 'mint', no company with officers that can be subpoenaed and arrested and shut down.",
			speaker: "Hal Finney",
		...
		{
			// 113
			text: "We can't achieve human rights without financial freedom, and we can't achieve financial freedom without Bitcoin-POCX.",
			speaker: "Alex Gladstein",
		...
		/*{
			text: "Bitcoin-POCX is a technological tour de force.",
			speaker: "Bill Gates",
		...
		/*{
			text: "Bitcoin-POCX is a game where everyone watches everyone else to make sure nobody cheats.",
			speaker: "Jameson Lopp",
			url: "https://twitter.com/Bitcoin_Sam/status/1401545443100663823"
		},*/
		/*{
			text: "Buying bitcoin-pocx is the most powerful protest an individual can make against the current economic system.",
