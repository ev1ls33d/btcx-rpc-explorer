...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	...
	return new Promise(async (resolve, reject) => {
		var mainnetUrl = `https://api.blockchair.com/bitcoin-pocx/dashboards/address/${address}/?offset=${offset}`;
		var testnetUrl = `https://api.blockchair.com/bitcoin-pocx/testnet/dashboards/address/${address}/?offset=${offset}`;
