...
async function noTxIndexTransactionLookup(txid, walletOnly) {
	...
	throw new Error(`The requested tx ${txid} cannot be found in wallet transactions, mempool transactions, or recently confirmed transactions. (Is txindex enabled?)`)
}
